...
# Test Object Files
TESTOBJECTFILES= \
	${TESTDIR}/tests/BorneFontaineTaisteur.o \
...
${TESTDIR}/TestFiles/f2: ${TESTDIR}/tests/BorneFontaineTaisteur.o ${OBJECTFILES:%.o=%_nomain.o}
...
${TESTDIR}/tests/BorneFontaineTaisteur.o: tests/BorneFontaineTaisteur.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/src/gtest/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/BorneFontaineTaisteur.o tests/BorneFontaineTaisteur.cpp
